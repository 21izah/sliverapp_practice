...
class EthereumBuyPage2 extends StatefulWidget {
  const EthereumBuyPage2({super.key});

  @override
  State<EthereumBuyPage2> createState() => _EthereumBuyPage2State();
}

class _EthereumBuyPage2State extends State<EthereumBuyPage2> {
                                ...
                                onChanged: (value) {
                                  ...
                                  if (number != null) {
                                    _nairaController.text =
                                        (number / _username.get(13)).toString();
                                  } else {
                                    _nairaController.text = '';
                                  }
                                },
                            ...
                            Navigator.of(context).push(
                              PageTransition(
                                child: BuyInformationPage(
                                  youGetNairaAmount: _btcController.text.trim(),
                                  youGetAmount:
